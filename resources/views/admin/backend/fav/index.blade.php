...
<div class="collapse" id="collapseExample">
    <div class="card card-body">
        ...
        <a href="{{asset('web_photo/'.$w->favicon)}}" class="btn btn-primary btn-sm" download><i
            ...
            <div class="pricing pricing-highlight">
                ...
                <div class="pricing-padding">
                    <div class="pricing-price">
                        <img src="{{asset('web_photo/'.$r->favicon)}}" alt="" srcset="">
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('fav.update',$f->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{asset('web_photo/'.$f->favicon)}}" alt="" style="width: 150px" class="ml-5">
