        ...
        <div class="col">
            <div class="card shadow mb-5">
                <div class="card-header py-3">
                    <h6 class="font-weight-bold text-primary">Sambutan</h6>
                </div>
                <div class="card-body">
                    <p>
                    ...
                    <div class="collapse" id="Visi">
                        <div class="card card-body">
                            <img src="{{asset('images/'.$sambutan->photo)}}" alt="" style="width: 200px">
                        </div>
                    </div>
                        ...
                        <div class="card card-body">
                            <form action="{{route('sambutan.update',$sambutan->id)}}" method="POST"
                                ...
                                <div class="form-group">
                                    <center>
                                        <img src="{{url('storage/images/'.$sambutan->photo)}}" alt="" id="showgambar"
                                            width="200px">
                                    </center>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="title" class="form-control" type="text" value="{{$sambutan->title}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="deskripsi" id="summernote"
                                        class="form-control">{!!$sambutan->deskripsi!!}</textarea>
                                </div>
